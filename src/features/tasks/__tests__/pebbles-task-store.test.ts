...
import { PebblesTaskStore, TaskStatus, TaskPriority, PebblesTask } from '../pebbles-task-store.js';
import { DatabaseError, TaskError, ErrorCode } from '../../../core/errors/index.js';
...
{"id": "valid-2", "type": "task_create", "timestamp": 2, "frame_id": "f2", "title": "Valid 2", "status": "pending", "priority": "high", "created_at": 2, "depends_on": [], "blocks": [], "tags": []}
  ...
  describe('Task Queries', () => {
    beforeEach(() => {
      ...
      const tasks = [
        { title: 'Active Task 1', status: 'pending' as TaskStatus, priority: 'high' as TaskPriority, frameId: 'frame-1' },
        { title: 'Active Task 2', status: 'in_progress' as TaskStatus, priority: 'medium' as TaskPriority, frameId: 'frame-1' },
        { title: 'Completed Task', status: 'completed' as TaskStatus, priority: 'low' as TaskPriority, frameId: 'frame-2' },
        { title: 'Blocked Task', status: 'blocked' as TaskStatus, priority: 'urgent' as TaskPriority, frameId: 'frame-3' },
        { title: 'Cancelled Task', status: 'cancelled' as TaskStatus, priority: 'medium' as TaskPriority, frameId: 'frame-3' }
      ];
  ...
  describe('Task Metrics', () => {
    beforeEach(() => {
      ...
      const tasks = [
        { title: 'Task 1', status: 'pending' as TaskStatus, priority: 'high' as TaskPriority },
        { title: 'Task 2', status: 'pending' as TaskStatus, priority: 'medium' as TaskPriority },
        { title: 'Task 3', status: 'completed' as TaskStatus, priority: 'low' as TaskPriority, effort: 30 },
        { title: 'Task 4', status: 'completed' as TaskStatus, priority: 'high' as TaskPriority, effort: 60 },
        { title: 'Task 5', status: 'blocked' as TaskStatus, priority: 'urgent' as TaskPriority },
        { title: 'Task 6', status: 'cancelled' as TaskStatus, priority: 'medium' as TaskPriority }
      ];
